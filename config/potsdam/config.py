...
from models.datasets.potsdam_dataset import *
from models.model.MIFNet import MIFNet
...
weights_path_name = 'weights'
weights_path = "model_weights/potsdam/{}".format(weights_path_name)
test_weights_name = "MIFNet"
...
#  define the network
net = MIFNet(num_classes=num_classes)
