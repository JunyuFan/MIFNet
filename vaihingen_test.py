...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default=r'config/vaihingen/unetformer.py', help="Path to config")
    arg("-o", "--output_path", type=Path, default=r'fig_results/vaihingen/unetformer', help="Path where to save resulting masks.")
